...
//
//  Modified by Milad Nozari on 3/10/17
//
...
extension PlayViewController: AVAudioPlayerDelegate {
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        audioPlayerNode.scheduleFile(audioFile, at: nil) {
            ...
            self.stopTimer = Timer(timeInterval: delayInSeconds, target: self, selector: #selector(PlayViewController.stopPlayback(_:)), userInfo: nil, repeats: false)
